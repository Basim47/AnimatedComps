...
const URL = 'https://www.linkedin.com/in/basim-shabbir-497a202b7?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app';
    ...
    <View
      ...
      <View style={styles.nameProfRow}>
        <Animated.View style={nameImg}>
          <Text style={styles.name}>{`Basim Shabbir`}</Text>
